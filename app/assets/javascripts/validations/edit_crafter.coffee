class @EditCrafter
  ...
  validate_edit_crafter_form: () ->
    if @utils.check_field('crafter[company_name]') &&  @utils.check_textarea_field('crafter[description]')&&  @utils.check_field('crafter[city]')&& @utils.check_field('crafter[address]')&& @utils.check_field('crafter[phone_number]')&& @utils.check_field('crafter[contact_person]')&& @utils.check_field('crafter[site]')&& @utils.check_field('crafter[work_time]')
